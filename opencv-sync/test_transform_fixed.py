#!/usr/bin/env python3
"""
Test the transform with correct camera indices and resolutions.
"""
...
def test_transform_fixed():
    """Test the perspective transform with correct setup."""
    print("Testing FaceCam to ZED Transform (Fixed)")
    print("=" * 40)
