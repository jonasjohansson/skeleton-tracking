#!/usr/bin/env python3
"""
Test the transform with proper scaling for native resolution.
"""
...
def test_transform_scaled():
    """Test the perspective transform with proper scaling."""
    print("FaceCam Transform with Scaling")
    print("=" * 35)
    ...
    # The transform was computed with FaceCam at 960x540 and ZED at 1920x1080
    # We need to scale it appropriately for the native resolution
    # Since we're staying at 960x540, we can use the transform as-is
    # But we might need to adjust the output size
    ...
    while True:
        ...
        # Use the same output size as input size to avoid scaling issues
        ...
        cv2.imshow("FaceCam: Original vs Transformed (Scaled)", combined)
