#!/usr/bin/env python3
"""
Show FaceCam original vs transformed at original resolution (960x540).
"""
...
def show_facecam_original_resolution():
    """Show FaceCam at original resolution."""
    print("FaceCam Original Resolution (960x540)")
    print("=" * 40)
    ...
    # Set to original FaceCam resolution
    cap_facecam.set(cv2.CAP_PROP_FRAME_WIDTH, 960)
    cap_facecam.set(cv2.CAP_PROP_FRAME_HEIGHT, 540)
    ...
    while True:
        ...
        # Apply perspective transform at original resolution
...
if __name__ == "__main__":
    show_facecam_original_resolution()
