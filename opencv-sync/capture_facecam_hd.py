#!/usr/bin/env python3
"""
Capture FaceCam images at HD resolution (1920x1080).
"""
...
def capture_facecam_hd():
    """Capture FaceCam images at HD resolution."""
    print("FaceCam HD Capture")
    print("=" * 20)
    ...
    print(f"FaceCam resolution: {width}x{height} @ {fps:.1f}fps")
    ...
    while True:
        ...
        cv2.putText(vis, f"FaceCam HD - {width}x{height}", (10, 30), 
        ...
        cv2.imshow("FaceCam HD Calibration", vis)
    ...
    print(f"Captured {saved_count} HD FaceCam images")
