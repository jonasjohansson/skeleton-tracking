#!/usr/bin/env python3
"""
Show FaceCam original vs transformed side by side.
"""
...
def show_facecam_comparison():
    """Show FaceCam original vs transformed."""
    print("FaceCam Original vs Transformed")
    print("=" * 35)
    ...
    while True:
        ...
        cv2.imshow("FaceCam: Original vs Transformed", combined)
